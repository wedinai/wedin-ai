...
export default function GTMDashboard() {
  ...
  const T = {
    ...
    hdr:      { background:navy, borderBottom:"none", padding:"16px 20px 0" },
    hdrTop:   { display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:2 },
    brand:    { fontFamily:"'Cormorant Garamond',serif", fontSize:20, letterSpacing:"0.14em", color:cream },
    lockBtn:  { fontSize:10, color:"rgba(250,247,242,0.45)", background:"none", border:"none", cursor:"pointer", letterSpacing:"0.12em", textTransform:"uppercase", padding:0 },
    sub:      { fontSize:9, color:"rgba(250,247,242,0.45)", letterSpacing:"0.17em", textTransform:"uppercase", marginBottom:14 },
    tabs:     { display:"flex", gap:0, overflowX:"auto", scrollbarWidth:"none" },
    tab:      a => ({ padding:"9px 18px", fontSize:11, fontWeight:a?600:400, color:a?gold:"rgba(250,247,242,0.5)", background:"none", border:"none", borderBottom:a?`2px solid ${gold}`:"2px solid transparent", cursor:"pointer", whiteSpace:"nowrap" }),
    body:     { padding:"20px", maxWidth:680, margin:"0 auto" },
    h1:       { fontFamily:"'Cormorant Garamond',serif", fontSize:22, color:navy, fontWeight:400, marginBottom:2 },
    label:    { fontSize:9, textTransform:"uppercase", letterSpacing:"0.15em", color:grey, marginBottom:6, display:"block" },
    card:     { background:white, border:`1px solid ${navyBorder}`, borderRadius:12, padding:"14px 16px", marginBottom:8, boxShadow:"0 2px 12px rgba(28,43,58,0.06)" },
    row:      { display:"flex", justifyContent:"space-between", alignItems:"flex-start", gap:12 },
    meta:     { fontSize:10, color:grey, marginTop:3 },
    em:       { fontSize:10, color:navy, fontFamily:"monospace", marginTop:2, opacity:0.6 },
    tag:      { display:"inline-block", padding:"1px 7px", borderRadius:100, fontSize:9, background:cream, color:grey, border:`1px solid ${navyBorder}`, marginRight:3, marginTop:2 },
    inp:      { background:cream, border:`1.5px solid ${navyBorder}`, borderRadius:8, color:navy, padding:"8px 11px", fontSize:11, width:"100%", boxSizing:"border-box", outline:"none", marginBottom:8 },
    textarea: { background:cream, border:`1.5px solid ${navyBorder}`, borderRadius:8, color:navy, padding:"8px 11px", fontSize:11, width:"100%", boxSizing:"border-box", outline:"none", resize:"vertical", minHeight:56, fontFamily:"'DM Sans',sans-serif", marginBottom:8 },
    btn:      a => ({ padding:"5px 12px", fontSize:10, borderRadius:8, cursor:"pointer", background:a?navy:white, color:a?cream:navy, border:`1.5px solid ${a?navy:navyBorder}`, fontWeight:500, letterSpacing:"0.06em", textTransform:"uppercase", whiteSpace:"nowrap", boxShadow:a?"0 2px 6px rgba(28,43,58,0.18)":"0 1px 3px rgba(28,43,58,0.08)" }),
    btnPrim:  { padding:"9px 18px", fontSize:11, borderRadius:8, cursor:"pointer", background:navy, color:cream, border:"none", fontWeight:500, letterSpacing:"0.07em", textTransform:"uppercase", boxShadow:"0 2px 8px rgba(28,43,58,0.18)" },
    pill:     c => ({ display:"inline-flex", alignItems:"center", padding:"3px 9px", borderRadius:100, fontSize:9, fontWeight:600, letterSpacing:"0.08em", textTransform:"uppercase", background:`${c}15`, color:c, border:`1px solid ${c}40` }),
    divider:  { borderTop:`1px solid ${navyBorder}`, margin:"14px 0" },
    grid3:    { display:"grid", gridTemplateColumns:"repeat(3, 1fr)", gap:8, marginBottom:14 },
    goldCard: { background:white, border:`1px solid ${navyBorder}`, borderLeft:`3px solid ${gold}`, borderRadius:"0 12px 12px 0", padding:"14px 16px", marginBottom:8, boxShadow:"0 2px 12px rgba(28,43,58,0.06)" },
  };
