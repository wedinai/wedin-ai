...
// Coordinators — full list, with already-contacted ones pre-marked
const COORDINATORS = [
  // ALREADY CONTACTED (pre-marked as emailed)
  ...
  { id:"c16", name:"Zavion",      biz:"Zavion Kotze Events",       handle:"@zavionkotzeeventscompany",  region:"Johannesburg",   status:"followed",     notes:"" },
  ...
  // TO EMAIL
  { id:"c19", name:"Beatrix",     biz:"Beatrix Events",            handle:"@beatrixevents",             region:"Johannesburg",   status:"to_email",     notes:"" },
  { id:"c20", name:"",            biz:"I Do Box",                  handle:"@idobox",                    region:"Cape Town",      status:"to_email",     notes:"" },
  { id:"c21", name:"",            biz:"Celebration Theory",        handle:"@celebrationtheory",         region:"Cape Town",      status:"to_email",     notes:"" },
  { id:"c22", name:"",            biz:"Piece of Cake Weddings",    handle:"@pieceofcakecapetown",       region:"Cape Town",      status:"to_email",     notes:"" },
  { id:"c23", name:"",            biz:"On the Day Events",         handle:"@onthedayevents",            region:"Cape Town",      status:"to_email",     notes:"" },
  { id:"c24", name:"",            biz:"Weddings by Marius",        handle:"@weddingsbymarius",          region:"South Africa",   status:"to_email",     notes:"" },
  { id:"c25", name:"Grace",       biz:"Dear Grace Event Spec.",    handle:"@dear_grace_event_specialists_", region:"Cape Town",  status:"to_email",     notes:"" },
  { id:"c26", name:"Cara Lee",    biz:"Mosaic Weddings",           handle:"@mosaicweddings",            region:"Cape Town",      status:"to_email",     notes:"" },
  { id:"c27", name:"",            biz:"Paheli Weddings",           handle:"@paheliweddings",            region:"South Africa",   status:"to_email",     notes:"" },
  { id:"c28", name:"",            biz:"The Wedding Fairy",         handle:"@thewedding_fairy",          region:"Cape Town",      status:"to_email",     notes:"" },
  { id:"c29", name:"",            biz:"Trunk Events",              handle:"@trunkevents",               region:"Cape Town",      status:"to_email",     notes:"" },
  { id:"c30", name:"",            biz:"On Reserve Events",         handle:"@onreserveevents",           region:"South Africa",   status:"to_email",     notes:"" },
  { id:"c31", name:"",            biz:"Watermelon Weddings",       handle:"@watermelonweddings",        region:"Cape Town",      status:"to_email",     notes:"" },
  { id:"c32", name:"",            biz:"Bright Light Events",       handle:"@brightlight.events",        region:"South Africa",   status:"to_email",     notes:"" },
  { id:"c33", name:"",            biz:"Infinite Luxe Weddings",    handle:"@infiniteluxeweddings",      region:"South Africa",   status:"to_email",     notes:"" },
  { id:"c34", name:"",            biz:"Garden Route Weddings",     handle:"@gardenroutewedd",           region:"Garden Route",   status:"to_email",     notes:"" },
  { id:"c35", name:"",            biz:"Bubblesco Events",          handle:"@bubblesco_events",          region:"Garden Route",   status:"to_email",     notes:"" },
  { id:"c36", name:"",            biz:"Nicolette Weddings",        handle:"@nicoletteweddings",         region:"Cape Town",      status:"to_email",     notes:"" },
  { id:"c37", name:"",            biz:"Dure Events",               handle:"@dureevents",                region:"International",  status:"to_email",     notes:"" },
  { id:"c38", name:"Zavion",      biz:"Zavion Kotze-Brereton",     handle:"@zavionk",                   region:"Johannesburg",   status:"to_email",     notes:"Celebrity designer, 117K followers" },
  { id:"c39", name:"",            biz:"Mehfil Haus",               handle:"@mehfilhaus",                region:"Durban",         status:"to_email",     notes:"" },
  { id:"c40", name:"",            biz:"Wedding Boutique SA",       handle:"@weddingboutiquesa",         region:"Johannesburg",   status:"to_email",     notes:"" },
];
