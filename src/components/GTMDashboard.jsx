...
const COORDINATORS = [
  // ── ALREADY CONTACTED ────────────────────────────────────────────────────
  { id:"c01", name:"Nicola Jane", biz:"Nicola Jane Weddings",      handle:"@nicolajaneweddings",            region:"Cape Town",     status:"coupon_sent", notes:"Coupon sent. Code: NICOLA 123456. Offered to share with coordinator WhatsApp group (~60 members)." },
  { id:"c02", name:"Anne Mann",   biz:"Anne Mann Weddings",        handle:"@anne.mann",                     region:"Cape Town",     status:"coupon_sent", notes:"Coupon sent. Code: ANNE 123456" },
  { id:"c03", name:"Nadine",      biz:"Works with Anne Mann",      handle:"",                               region:"Cape Town",     status:"coupon_sent", notes:"Coupon sent via Anne Mann. Code: NADINE 123456" },
  { id:"c04", name:"Joe Theron",  biz:"Works with Anne Mann",      handle:"",                               region:"Cape Town",     status:"coupon_sent", notes:"Coupon sent. Code: JOE 123456" },
  { id:"c05", name:"Christina Holt",biz:"Wedding Concepts SA",      handle:"@weddingconceptssa",             region:"Cape Town",     status:"coupon_sent", notes:"Coupon sent to Christina Holt. Code: WEDIN-WEDDINGCONCEPTS-A2B3DX" },
  { id:"c06", name:"Nicole",      biz:"Kraak Wedding and Events",  handle:"@kraak.co.za",                   region:"Cape Town",     status:"coupon_sent", notes:"Coupon sent. Code: WEDIN-KRAAK-A2B3DX" },
  { id:"c07", name:"Dayna",       biz:"Strawberry Weddings",       handle:"@strawberryweddingsandevents",   region:"Winelands",     status:"coupon_sent", notes:"Coupon sent. Code: WEDIN-STRAWBERRY-A2B3DX" },
  { id:"c08", name:"Nikki & Madri",biz:"The Event Planners SA",    handle:"@theeventplannerssa",            region:"Cape Town",     status:"coupon_sent", notes:"Coupon sent to Nikki and Madri. Code: WEDIN-EVENTPLANNERS-A2B3DX" },
  // ── COUPON SENT ──────────────────────────────────────────────────────────
  { id:"c09", name:"Ade",         biz:"Ethereal Events Co",        handle:"@etherealevents.co",             region:"Pretoria",      status:"coupon_sent", notes:"Coupon sent to Ade. Code: WEDIN-ETHEREAL-A2B3DX" },
  // ── FOLLOWED — not yet emailed ───────────────────────────────────────────
  { id:"c10", name:"",            biz:"Oh Happy Day SA",           handle:"@ohhappydaysouthafrica",         region:"Durban",        status:"followed",    notes:"" },
  { id:"c11", name:"",            biz:"Planning to Perfection",    handle:"@planningtoperfection_za",       region:"Johannesburg",  status:"coupon_sent", notes:"Coupon sent. Code: WEDIN-2PERFECTION-A2B3DX" },
  ...
  { id:"c19", name:"Cara Lee",    biz:"Mosaic Weddings",           handle:"@mosaicweddings",                region:"Cape Town",     status:"followed",    notes:"" },
  { id:"c20", name:"",            biz:"Piece of Cake Weddings",    handle:"@pieceofcakecapetown",           region:"Cape Town",     status:"followed",    notes:"" },
  { id:"c21", name:"",            biz:"On the Day Events",         handle:"@onthedayevents",                region:"Cape Town",     status:"followed",    notes:"12+ years experience" },
  { id:"c22", name:"Simone",      biz:"Dear Grace Event Spec.",    handle:"@dear_grace_event_specialists_", region:"Cape Town",     status:"coupon_sent", notes:"Coupon sent to Simone. Code: WEDIN-DEARGRACE-A2B3DX" },
  { id:"c23", name:"",            biz:"The Wedding Fairy",         handle:"@thewedding_fairy",              region:"Cape Town",     status:"followed",    notes:"10.1K followers, featured in The Lane" },
  ...
  { id:"c27", name:"",            biz:"Celebration Theory",        handle:"@celebrationtheory",             region:"Cape Town",     status:"followed",    notes:"" },
  { id:"c28", name:"",            biz:"I Do Box",                  handle:"@idobox",                        region:"Cape Town",     status:"followed",    notes:"10K followers, luxury" },
  ...
  { id:"c40", name:"",            biz:"Jubilee Weddings and Events",handle:"@jubileeweddingsandevents",     region:"Johannesburg",  status:"coupon_sent", notes:"Coupon sent. Code: WEDIN-JUBILEE-A2B3DX" },
  { id:"c41", name:"Zavion",      biz:"Zavion Kotze-Brereton",     handle:"@zavionk",                      region:"Johannesburg",  status:"followed",    notes:"Celebrity designer, 117K followers — approach thoughtfully" },
  ...
  // ── TO EMAIL — National ──────────────────────────────────────────────────
  { id:"c51", name:"",            biz:"Weddings by Marius",        handle:"@weddingsbymarius",             region:"South Africa",  status:"followed",    notes:"20+ years experience, 10K followers" },
  { id:"c52", name:"",            biz:"Paheli Weddings",           handle:"@paheliweddings",               region:"South Africa",  status:"followed",    notes:"Featured in Vogue India, 8K followers" },
