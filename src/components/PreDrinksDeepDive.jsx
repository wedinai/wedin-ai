...
const STEPS = [
  {
    ...
    type: 'chips',
    educate: "Pre-drinks is the most underplanned moment of the day. It often runs longer than expected — photos overrun, the couple disappears for 90 minutes — and the music has to carry the room entirely on its own. Get this right and guests arrive at dinner already feeling something. Get it wrong and the day loses momentum it never fully recovers.",
