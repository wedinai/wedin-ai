...
OUTDOOR AMPLIFICATION RULE: When venue_type is farm_bush, beach_outdoor, or destination — embed this exact sentence in the instruction field of Guest Arrivals, Ceremony, and Pre-drinks: 'Confirm the act has their own PA — acoustic music without amplification will not carry to all guests outdoors above 40 people.' This sentence must appear in ONLY these three moments. Never add it to Speeches, Dinner, Entrance, Dancing, or Last Song. It applies to all three listed moments regardless of whether a live act or a playlist is recommended.
