...
const { checkRateLimit, getIP, RATE_LIMITED_RESPONSE } = require("./utils/rateLimit");
...
exports.handler = async (event) => {
  ...
  if (event.httpMethod === "POST") {
    ...
    if (body.action === "update_status") {
      ...
      if (status === "followed") {
        // no timestamp columns for follow, just status
      }
